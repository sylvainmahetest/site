...
customElements.define("tag-exploretitle-gallery", class extends HTMLElement{});
...
let _eventScroll = 0;
let _tagExploretitleGallery = null;
...
function tag()
{
	...
	if (_foundTagBack === true)
	{
		_tagExploretitleGallery = document.getElementById("tag-exploretitle-gallery");
	}
...
function particuleAnimation()
{
	...
	const COUNT_PARTICLE = /*10000*/1000;
	const COUNT_PARTICLE_SHAPE = /*7500*/750;
	...
	for (indexParticule = 0; indexParticule < COUNT_PARTICLE; indexParticule++)
	{
		...
		if (indexParticule < COUNT_PARTICLE_SHAPE)
		{
			...
			if (randomInteger(1, 50) === 1)
			{
				...
				alphaStart[indexParticule] = /*0.008*/0.2;
			...
			{
				diameterStart[indexParticule] = randomFloat(3, 4);
				gradientStart[indexParticule] = 0.49;
				alphaStart[indexParticule] = /*0.008*/0.2;
				mass[indexParticule] = randomFloat(1, 1.1);
			...
			{
				diameterStart[indexParticule] = randomFloat(4, 10);
				gradientStart[indexParticule] = 0;
				alphaStart[indexParticule] = /*0.008*/0.05;
			...
			{
				diameterStart[indexParticule] = randomFloat(10, 15);
				gradientStart[indexParticule] = 0;
				alphaStart[indexParticule] = /*0.008*/0.05;
		...
		else
		{
			...
			if (randomInteger(1, 10) === 1)
			{
				diameterStart[indexParticule] = randomFloat(2, 3);
				gradientStart[indexParticule] = 0;
				alphaStart[indexParticule] = /*0.1*/0.3;
				mass[indexParticule] = randomFloat(1, 1.1);
			...
			else if (randomInteger(1, 5) === 1)
			{
				...
				gradientStart[indexParticule] = 0;
				alphaStart[indexParticule] = /*0.04*/0.12;
				mass[indexParticule] = randomFloat(1, 1.1);
			...
			else if (randomInteger(1, 10) !== 1)
			{
				...
				gradientStart[indexParticule] = 0;
				alphaStart[indexParticule] = /*0.006*/0.018;
				mass[indexParticule] = randomFloat(1.1, 2);
...
function windowResize()
{
	_FUNCTION.resize = function()
	{
		...
		if (_foundTagBack === true)
		{
			//fitTextParentWidth(_tagExploretitleGallery, 10, 55, 0, 65);
			fitTextParentWidth(_tagExploretitleGallery, 10, 60, 0, 70);
		}
	}
...
function interfaceAnimation()
{
	...
	let opacityTagLineTransitionLeave = 0;
	let leftTagLineTransitionLeave = 0;
	let widthTagLineTransitionLeave = 0;
	let opacityTagName = 0;
	let transformTagName = 0;
	let opacityTagLetter = []
	let widthTagLetter = [];
	let opacityTagBack = 0;
	let transformTagBack = 0;
	let opacityTagOverlayHeader = 0;
	let transformTagOverlayHeader = 0;
	let opacityTagOvertitleHeader = 0;
	let transformTagOvertitleHeader = 0;
	let opacityTagTitleHeader = 0;
	let transformTagTitleHeader = 0;
	let opacityTagSubtitleHeader = 0;
	let transformTagSubtitleHeader = 0;
	let opacityTagScrollDownHeader = 0;
	let transformTagScrollDownHeader = 0;
	let topTagOverlayGallery = 0;
	let opacityTagOverlayGallery = 0;
	let transformTagOverlayGallery = 0;
	let transformTagOvermaintitleGallery = 0;
	let transformTagMaintitleGallery = 0;
	let opacityTagMediaGallery = [];
	let heightTagMediaGallery = [];
	let transformTagMediaGallery = [];
	let objectPositionTagImg = [];
	let transformTagButtonGallery = [];
	let opacityTagLineFooter = 0;
	let transformTagLineFooter = 0;
	let opacityTagContactFooter = 0;
	let transformTagContactFooter = 0;
	let textContentTagResponseContact = 0;
	let opacityTagResponseContact = 0;
	let backgroundColorTagResponseContact = 0;
